...
sim: command line: /home/dulea/Documents/University/RpoiectAA/ProiectAA-ServerSide/ProiectAAServerSide/ProiectAAServerSide/bin/Release/sim/sim-outorder -redir:sim outputs/output_23042024_10:19:52.res -max:inst 5000000 -cache:dl1 dl1:128:32:4:l -fetch:ifqsize 4 -fetch:mplat 3 -issue:inorder true -issue:width 4 -ruu:size 16 benchs/ss/su2cor.ss 

sim: simulation started @ Tue Apr 23 10:19:52 2024, options follow:
...
# -redir:sim     outputs/output_23042024_10:19:52.res # redirect simulator output to file (non-interactive only)
...
sim_total_insn              5615154 # total number of instructions executed
sim_total_refs              1515947 # total number of loads and stores executed
sim_total_loads              836634 # total number of loads executed
sim_total_stores        679313.0000 # total number of stores executed
sim_total_branches           768389 # total number of branches executed
sim_cycle                   5866471 # total simulation time in cycles
sim_IPC                      0.8523 # instructions per cycle
sim_CPI                      1.1733 # cycles per instruction
sim_exec_BW                  0.9572 # total instructions (mis-spec + committed) per cycle
sim_IPB                      6.5172 # instruction per branch
IFQ_count                  20362906 # cumulative IFQ occupancy
IFQ_fcount                  4808993 # cumulative IFQ full count
ifq_occupancy                3.4711 # avg IFQ occupancy (insn's)
ifq_rate                     0.9572 # avg IFQ dispatch rate (insn/cycle)
ifq_latency                  3.6264 # avg IFQ occupant latency (cycle's)
ifq_full                     0.8197 # fraction of time (cycle's) IFQ was full
RUU_count                  17073279 # cumulative RUU occupancy
RUU_fcount                        0 # cumulative RUU full count
ruu_occupancy                2.9103 # avg RUU occupancy (insn's)
ruu_rate                     0.9572 # avg RUU dispatch rate (insn/cycle)
ruu_latency                  3.0406 # avg RUU occupant latency (cycle's)
ruu_full                     0.0000 # fraction of time (cycle's) RUU was full
LSQ_count                   5307671 # cumulative LSQ occupancy
LSQ_fcount                       14 # cumulative LSQ full count
lsq_occupancy                0.9047 # avg LSQ occupancy (insn's)
lsq_rate                     0.9572 # avg LSQ dispatch rate (insn/cycle)
lsq_latency                  0.9452 # avg LSQ occupant latency (cycle's)
lsq_full                     0.0000 # fraction of time (cycle's) LSQ was full
sim_slip                   27579436 # total number of slip cycles
avg_sim_slip                 5.5159 # the average slip between issue and retirement
bpred_bimod.lookups          859093 # total number of bpred lookups
...
bpred_bimod.retstack_pushes         2374 # total number of address pushed onto ret-addr stack
bpred_bimod.retstack_pops         2142 # total number of address popped off of ret-addr stack
...
il1.accesses                6345065 # total number of accesses
il1.hits                    6340552 # total number of hits
il1.misses                     4513 # total number of misses
il1.replacements               4007 # total number of replacements
...
ul2.accesses                  42472 # total number of accesses
ul2.hits                      38335 # total number of hits
ul2.misses                     4137 # total number of misses
ul2.replacements                482 # total number of replacements
ul2.writebacks                  226 # total number of writebacks
ul2.invalidations                 0 # total number of invalidations
ul2.miss_rate                0.0974 # miss rate (i.e., misses/ref)
ul2.repl_rate                0.0113 # replacement rate (i.e., repls/ref)
ul2.wb_rate                  0.0053 # writeback rate (i.e., wrbks/ref)
ul2.inv_rate                 0.0000 # invalidation rate (i.e., invs/ref)
itlb.accesses               6345065 # total number of accesses
itlb.hits                   6345022 # total number of hits
...
mem.ptab_accesses          38391264 # total page table accesses
